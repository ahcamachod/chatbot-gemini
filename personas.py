...
def seleccionar_persona(mensaje_usuario):
    prompt_sistema = f""" 
                        ...
                        1. Realiza un análisis del mensaje proporcionado por el usuario para identificar si el sentimiento es: positivo, neutro o negativo.
                        2. Devuelve solo uno de los tres tipos de sentimientos indicados como respuesta.

                        Formato de Salida: solo el sentimiento en letras minúsculas, sin espacios, ni caracteres especiales, ni saltos de línea.
